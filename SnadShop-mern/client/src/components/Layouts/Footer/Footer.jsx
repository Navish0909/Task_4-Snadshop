      ...
      {!adminRoute && (
        <>
          <footer className="mt-20 w-full py-1 sm:py-4 px-4 sm:px-12 bg-primary-darkBlue text-white text-xs border-b border-gray-600 flex flex-col sm:flex-row overflow-hidden">
            ...
            <div className="border-white-600 h-36 w-1 border-l mr-5 mt-6 hidden sm:block"></div>
          ...
          <div className="px-16 py-6 w-full bg-primary-#acc7e8 hidden sm:flex justify-between items-center text-sm text-white">
